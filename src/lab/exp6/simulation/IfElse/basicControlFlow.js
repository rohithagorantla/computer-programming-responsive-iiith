...
window.view = {
		...
		if (this.nextSiblingElement.id === 'codeContentIfElse23Id' || this.nextSiblingElement.id === 'codeContentIfElse27Id') {
			...
			if (this.nextOfnextSiblingElement.id === 'codeContentIfElse20Id' || this.nextOfnextSiblingElement.id === 'codeContentIfElse22Id') {
				if (this.nextOfnextSiblingElement.id === 'codeContentIfElse20Id') 
					this.codeExecutionWithColourAndId('codeContentIfElse20Id');
				else if (model.valueOfX > 50 && model.valueOfX < 250 && model.valueOfY > 50 && model.valueOfY < 325) {
	...
	executionOfIfElseIfElse: function () {
		...
		if (this.nextSiblingElement.id === 'codeContentIfElseIf3bId' && model.valueOfX > 300) 
			this.codeExecutionWithColourAndId('codeContentIfElseIf3cId');
		if (this.nextSiblingElement.id === 'codeContentIfElseIf3dId' && model.valueOfX > 300) 
			this.changeFlagValue('flagValue1', 'codeContentIfElseIf5Id', '0');
		if (this.nextSiblingElement.id === 'codeContentIfElseIf3bId' && (75 <= model.valueOfX) && (model.valueOfX <= 300)) 
			this.codeExecutionWithColourAndId('codeContentIfElseIf3cId');
		if (this.nextSiblingElement.id === 'codeContentIfElseIf3dId' && (75 <= model.valueOfX) && (model.valueOfX <= 300)) 
		...
		if ((this.nextSiblingElement.id === 'codeContentIfElseIf12Id' || this.nextSiblingElement.id === 'codeContentIfElseIf14Id' || this.nextSiblingElement.id === 'codeContentIfElseIf16Id') && (75 <= model.valueOfX) && (model.valueOfX <= 300) && (75 <= model.valueOfY) && (model.valueOfY <= 325))	{
			this.changeFlagValue('flagValue1', this.nextOfnextSiblingElement.id, '1');
			if ((this.nextSiblingElement.id === 'codeContentIfElseIf16Id') && (50 <= model.valueOfX) && (model.valueOfX <= 275) && (75 <= model.valueOfY) && (model.valueOfY <= 325)) {
				this.displayTextWithColour('Output: INSIDE', 100, 40, '#FF2400');
			}
		}
